...
/**
 * @param {unknown} body
 * @returns {{ ok: true, items: Array<{slug:string,productKey:string,quantity:number,printifyProductId:string,printifyVariantId:string,sku:string,productName:string}>} | { ok: false, error: string }}
 */
