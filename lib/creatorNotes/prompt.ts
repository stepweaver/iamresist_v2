...
const KIND_INSTRUCTIONS = [
  ...
  'evidence_reference: Use only when the creator explicitly invokes an external evidentiary source such as an article, publication, report, official statement, government or agency document, filing, dataset, statistic source, or named institutional source. Examples: Wall Street Journal, Lloyd\'s of London, IAEA report, Pentagon statement. The named source must appear in this evidence window. Do not use evidence_reference when the note is about a subject country, actor, target, or an institution merely discussed.',
...
const GROUNDING_INSTRUCTIONS = [
  ...
  'Episode title and source metadata are not evidence. Do not copy them into note text unless the same words appear in this window.',
  'Do not paraphrase evidence as a quotation.',
