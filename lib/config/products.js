...
export const PRODUCT_CONFIG = {
  ...
  // [ANTIFA] Bumper Sticker - Individual - $10.00
  antifaIndividual: {
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_ID_ANTIFA_INDIVIDUAL || process.env.STRIPE_PRICE_ID_ANTIFA_INDIVIDUAL || '',
    printifyProductId: process.env.PRINTIFY_PRODUCT_ID_ANTIFA || process.env.PRINTIFY_PRODUCT_ID || '',
    quantity: 1,
    unitAmountCents: 1000,
    freeShipping: false,
    sku: 'ANTIFA-STICKER-001',
    productSlug: 'antifa',
    productName: '[ANTIFA] Bumper Sticker',
  },
  // [ANTIFA] Bumper Sticker - 3-Pack - $24.00 + Free Shipping
  antifaThreePack: {
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_ID_ANTIFA_3PACK || process.env.STRIPE_PRICE_ID_ANTIFA_3PACK || '',
    printifyProductId: process.env.PRINTIFY_PRODUCT_ID_ANTIFA || process.env.PRINTIFY_PRODUCT_ID || '',
    quantity: 3,
    unitAmountCents: 2400,
    freeShipping: true,
    sku: 'ANTIFA-STICKER-003',
    productSlug: 'antifa',
    productName: '[ANTIFA] Bumper Sticker',
  },
  // [ANTIFA] Bumper Sticker - 5-Pack - $36.00 + Free Shipping
  antifaFivePack: {
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_ID_ANTIFA_5PACK || process.env.STRIPE_PRICE_ID_ANTIFA_5PACK || '',
    printifyProductId: process.env.PRINTIFY_PRODUCT_ID_ANTIFA || process.env.PRINTIFY_PRODUCT_ID || '',
    quantity: 5,
    unitAmountCents: 3600,
    freeShipping: true,
    sku: 'ANTIFA-STICKER-005',
    productSlug: 'antifa',
    productName: '[ANTIFA] Bumper Sticker',
  },
  // BELIEVE NOTHING Bumper Sticker - Individual - $10.00
  believeNothingIndividual: {
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_ID_BELIEVE_NOTHING_INDIVIDUAL || process.env.STRIPE_PRICE_ID_BELIEVE_NOTHING_INDIVIDUAL || '',
    printifyProductId: process.env.PRINTIFY_PRODUCT_ID_BELIEVE_NOTHING || process.env.PRINTIFY_PRODUCT_ID || '',
    printifyVariantId: process.env.PRINTIFY_VARIANT_ID_BELIEVE_NOTHING || '',
    quantity: 1,
    unitAmountCents: 1000,
    freeShipping: false,
    sku: 'BELIEVE-NOTHING-STICKER-001',
    productSlug: 'believe-nothing',
    productName: 'BELIEVE NOTHING Bumper Sticker',
  },
  // BELIEVE NOTHING Bumper Sticker - 3-Pack - $24.00 + Free Shipping
  believeNothingThreePack: {
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_ID_BELIEVE_NOTHING_3PACK || process.env.STRIPE_PRICE_ID_BELIEVE_NOTHING_3PACK || '',
    printifyProductId: process.env.PRINTIFY_PRODUCT_ID_BELIEVE_NOTHING || process.env.PRINTIFY_PRODUCT_ID || '',
    printifyVariantId: process.env.PRINTIFY_VARIANT_ID_BELIEVE_NOTHING || '',
    quantity: 3,
    unitAmountCents: 2400,
    freeShipping: true,
    sku: 'BELIEVE-NOTHING-STICKER-003',
    productSlug: 'believe-nothing',
    productName: 'BELIEVE NOTHING Bumper Sticker',
  },
  // BELIEVE NOTHING Bumper Sticker - 5-Pack - $36.00 + Free Shipping
  believeNothingFivePack: {
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_ID_BELIEVE_NOTHING_5PACK || process.env.STRIPE_PRICE_ID_BELIEVE_NOTHING_5PACK || '',
    printifyProductId: process.env.PRINTIFY_PRODUCT_ID_BELIEVE_NOTHING || process.env.PRINTIFY_PRODUCT_ID || '',
    printifyVariantId: process.env.PRINTIFY_VARIANT_ID_BELIEVE_NOTHING || '',
    quantity: 5,
    unitAmountCents: 3600,
    freeShipping: true,
    sku: 'BELIEVE-NOTHING-STICKER-005',
    productSlug: 'believe-nothing',
    productName: 'BELIEVE NOTHING Bumper Sticker',
  },
};
