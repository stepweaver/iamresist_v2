...
import { congressGovApiConfigured, congressGovEndpoint, currentCongressNumber } from '@/lib/intel/congressGov';
...
export function getSignalSources(): SignalSourceConfig[] {
  const congressGovEnabled = congressGovApiConfigured();
  ...
  return [
    ...
    {
      slug: 'congress-bills-recent',
      name: 'Congress.gov — Recent bills',
      provenanceClass: 'PRIMARY',
      fetchKind: 'congress_api',
      deskLane: 'osint',
      sourceFamily: 'congress_primary',
      contentUseMode: 'feed_summary',
      endpointUrl: congressGovEndpoint('/bill', { limit: 50, sort: 'updateDate+desc' }),
      isEnabled: congressGovEnabled,
      isCoreSource: true,
      trustWarningMode: 'none',
      trustWarningLevel: 'info',
      requiresIndependentVerification: false,
      heroEligibilityMode: 'normal',
      purpose: 'Structured Congress.gov v3 bill records and recent bill/text updates.',
      trustedFor: 'Primary bill identifiers, titles, latest-action pointers, and bill text update timestamps surfaced by Congress.gov.',
      notTrustedFor: 'Independent impact analysis, political claims, or proof that a bill will advance.',
      editorialNotes:
        'Requires CONGRESS_GOV_API_KEY. The registry stores the endpoint without the key; ingestion appends the key at request time.',
      editorialControls: {
        defaultPriority: 52,
        preferredStateChangeTypes: ['bill_action', 'bill_text_updated', 'legislative_feed_item'],
        blockKeywords: ['commemorative', 'post office', 'mint coins', 'congratulating'],
        allowKeywords: ['surveillance', 'detention', 'war powers', 'oversight', 'civil liberties', 'immigration'],
      },
      ingestIntervalMinutes: 20,
    },
    {
      slug: 'congress-committee-meetings-house',
      name: 'Congress.gov — House committee meetings',
      provenanceClass: 'PRIMARY',
      fetchKind: 'congress_api',
      deskLane: 'osint',
      sourceFamily: 'congress_primary',
      contentUseMode: 'feed_summary',
      endpointUrl: congressGovEndpoint(`/committee-meeting/${congress}/house`, { limit: 50 }),
      isEnabled: congressGovEnabled,
      isCoreSource: true,
      trustWarningMode: 'none',
      trustWarningLevel: 'info',
      requiresIndependentVerification: false,
      heroEligibilityMode: 'normal',
      purpose: 'Structured House committee meeting, hearing, markup, witness, and document signals from Congress.gov.',
      trustedFor: 'Committee meeting schedules, statuses, related bills, witness lists, and posted witness/meeting documents when present in the API response.',
      notTrustedFor: 'Claims made by witnesses or members inside the hearing.',
      editorialNotes:
        'Requires CONGRESS_GOV_API_KEY; creator or press-release claims about hearings should be treated as leads until corroborated here or by trusted reporting.',
      editorialControls: {
        defaultPriority: 62,
        preferredStateChangeTypes: ['committee_meeting', 'committee_markup', 'witness_list_posted', 'witness_statement_posted'],
        allowKeywords: ['hearing', 'markup', 'witness', 'oversight', 'subpoena', 'surveillance', 'detention'],
      },
      ingestIntervalMinutes: 15,
    },
    {
      slug: 'congress-committee-meetings-senate',
      name: 'Congress.gov — Senate committee meetings',
      provenanceClass: 'PRIMARY',
      fetchKind: 'congress_api',
      deskLane: 'osint',
      sourceFamily: 'congress_primary',
      contentUseMode: 'feed_summary',
      endpointUrl: congressGovEndpoint(`/committee-meeting/${congress}/senate`, { limit: 50 }),
      isEnabled: congressGovEnabled,
      isCoreSource: true,
      trustWarningMode: 'none',
      trustWarningLevel: 'info',
      requiresIndependentVerification: false,
      heroEligibilityMode: 'normal',
      purpose: 'Structured Senate committee meeting and hearing signals from Congress.gov.',
      trustedFor: 'Committee meeting schedule/status and related meeting metadata published by Congress.gov.',
      notTrustedFor: 'Claims made by witnesses or members inside the hearing.',
      editorialControls: {
        defaultPriority: 60,
        preferredStateChangeTypes: ['committee_meeting', 'committee_markup', 'witness_list_posted', 'witness_statement_posted'],
        allowKeywords: ['hearing', 'markup', 'witness', 'oversight', 'surveillance', 'detention'],
      },
      ingestIntervalMinutes: 15,
    },
    {
      slug: 'congress-summaries',
      name: 'Congress.gov — Bill summaries',
      provenanceClass: 'PRIMARY',
      fetchKind: 'congress_api',
      deskLane: 'osint',
      sourceFamily: 'congress_primary',
      contentUseMode: 'feed_summary',
      endpointUrl: congressGovEndpoint('/summaries', { limit: 50 }),
      isEnabled: congressGovEnabled,
      isCoreSource: true,
      trustWarningMode: 'none',
      trustWarningLevel: 'info',
      requiresIndependentVerification: false,
      heroEligibilityMode: 'normal',
      purpose: 'CRS-written bill summary publication/update feed from Congress.gov.',
      trustedFor: 'Bill-summary text and associated legislative action descriptions as published through Congress.gov.',
      notTrustedFor: 'Breaking procedural action by itself; use actions, committee meetings, and votes for active movement.',
      editorialControls: {
        defaultPriority: 48,
        preferredStateChangeTypes: ['bill_summary'],
        allowKeywords: ['detention', 'surveillance', 'war powers', 'civil liberties', 'environmental health'],
      },
      ingestIntervalMinutes: 30,
    },
    {
      slug: 'congress-house-votes',
      name: 'Congress.gov — House roll-call votes',
      provenanceClass: 'PRIMARY',
      fetchKind: 'congress_api',
      deskLane: 'osint',
      sourceFamily: 'congress_primary',
      contentUseMode: 'metadata_only',
      endpointUrl: congressGovEndpoint('/house-vote', { limit: 50 }),
      isEnabled: congressGovEnabled,
      isCoreSource: true,
      trustWarningMode: 'none',
      trustWarningLevel: 'info',
      requiresIndependentVerification: false,
      heroEligibilityMode: 'normal',
      purpose: 'House roll-call vote records from the Congress.gov v3 House vote endpoint.',
      trustedFor: 'Primary vote records, roll numbers, questions, dates, and vote results returned by Congress.gov.',
      notTrustedFor: 'Senate roll-call coverage or member-intent analysis.',
      editorialControls: {
        defaultPriority: 66,
        preferredStateChangeTypes: ['house_roll_call_vote'],
        allowKeywords: ['surveillance', 'detention', 'war powers', 'immigration', 'civil liberties'],
      },
      ingestIntervalMinutes: 10,
    },
    {
      slug: 'congress-crs-reports',
      name: 'Congress.gov — CRS reports',
      provenanceClass: 'PRIMARY',
      fetchKind: 'congress_api',
      deskLane: 'osint',
      sourceFamily: 'congress_primary',
      contentUseMode: 'feed_summary',
      endpointUrl: congressGovEndpoint('/crsreport', { limit: 50 }),
      isEnabled: congressGovEnabled,
      isCoreSource: true,
      trustWarningMode: 'none',
      trustWarningLevel: 'info',
      requiresIndependentVerification: false,
      heroEligibilityMode: 'normal',
      purpose: 'Congressional Research Service reports and contextual research products from Congress.gov.',
      trustedFor: 'CRS context, summaries, topics, and related bill links.',
      notTrustedFor: 'Breaking action by itself; CRS can enrich and corroborate but is usually not the live procedural event.',
      editorialControls: {
        defaultPriority: 46,
        preferredStateChangeTypes: ['crs_report'],
        allowKeywords: ['surveillance', 'detention', 'war powers', 'civil liberties', 'immigration'],
      },
