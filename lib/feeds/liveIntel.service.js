...
function applyCreatorCorroborationBridge(items, creatorSupportItems, deskLane) {
  ...
  return items.map((item) => {
    ...
    const displayPriority = Math.min(100, baseDisplayPriority + decision.boost);
    ...
    const bridgeExplanation = {
      ...
      message: `Bounded creator corroboration bridge +${decision.boost} from trusted creator convergence around the same live story.`,
      meta: {
        boost: decision.boost,
        clusterId: decision.clusterId,
        representativeId: decision.representativeId,
    ...
    return {
      ...
      displayPriority,
      baseDisplayPriority,
      creatorCorroborationBoost: decision.boost,
...
const getHomepageBriefingDeskOsint = unstable_cache(
  ...
  ['homepage-briefing-desk-v3', 'osint'],
...
const getHomepageBriefingDeskWatchdogs = unstable_cache(
  ...
  ['homepage-briefing-desk-v3', 'watchdogs'],
  { revalidate: LIVE_INTEL_DESK_CACHE_TTL_SECONDS, tags: ['homepage-briefing', 'intel-live'] },
);
...
const getHomepageBriefingDeskDefenseOps = unstable_cache(
  ...
  ['homepage-briefing-desk-v3', 'defense_ops'],
  { revalidate: LIVE_INTEL_DESK_CACHE_TTL_SECONDS, tags: ['homepage-briefing', 'intel-live'] },
);
...
const getHomepageBriefingDeskVoices = unstable_cache(
  ...
  ['homepage-briefing-desk-v3', 'voices'],
  { revalidate: LIVE_INTEL_DESK_CACHE_TTL_SECONDS, tags: ['homepage-briefing', 'intel-live'] },
);
