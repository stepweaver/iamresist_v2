...
export const SHOP_PRODUCTS = [
  ...
  },
  {
    ...
    price: 6.0,
    tagline: 'Trump Always Chickens Out',
    description:
  ...
  {
    slug: 'antifa',
    name: '[ANTIFA] Bumper Sticker',
    price: 10.0,
    tagline: 'The organization is fake. The crackdown is real.',
    description:
      "They needed a monster. So they invented one.\n\nThere is no Antifa headquarters. No membership card. No uniform. No chain of command. Just people who refuse fascism, and a state desperate to turn dissent into a crime.\n\nAfter the first Texas rulings came down, the message was clear: make an example, build the myth, point to the punishment, and say, See? The enemy is real.\n\nThat is why this sticker exists.\n\nIt is bold because the lie is bold. It is absurd because the accusation is absurd. It is angry because some of us have served this country and know the difference between patriotism and obedience.\n\nSlap it somewhere visible. Let the cowards clutch pearls. Let the bootlickers explain the imaginary organization they're so afraid of.\n\nWeatherproof, UV-resistant, car-durable vinyl. Built for bumpers, toolboxes, laptops, water bottles, and anywhere else the myth needs mocking.",
    basePrice: 10.0,
    freeShippingThreshold: 24.0,
    image: '/antifa_sticker.png',
    features: SHARED_FEATURES,
    specs: [
      ...SHARED_SPECS.filter((s) => s.label !== 'Size'),
      { label: 'Size', value: '7.5" × 3.75" bumper sticker' },
    ],
    bundles: buildBundles([
      { quantity: 1, price: 10.0, label: '1 Sticker', productKey: 'antifaIndividual', priceIdKey: 'NEXT_PUBLIC_STRIPE_PRICE_ID_ANTIFA_INDIVIDUAL', freeShipping: false },
      { quantity: 3, price: 24.0, label: '3 Stickers', productKey: 'antifaThreePack', priceIdKey: 'NEXT_PUBLIC_STRIPE_PRICE_ID_ANTIFA_3PACK', freeShipping: true },
      { quantity: 5, price: 36.0, label: '5 Stickers', productKey: 'antifaFivePack', priceIdKey: 'NEXT_PUBLIC_STRIPE_PRICE_ID_ANTIFA_5PACK', freeShipping: true },
    ]),
  },
  {
    slug: 'believe-nothing',
    name: 'BELIEVE NOTHING Bumper Sticker',
    price: 10.0,
    tagline: 'Believe nothing you hear, and only half what you see.',
    description:
      "Printed on weatherproof, UV-resistant, car-durable vinyl. Built for bumpers, toolboxes, laptops, and anywhere a claim needs a second look.",
    basePrice: 10.0,
    freeShippingThreshold: 24.0,
    image: '/believe-nothing-bumper-sticker.png',
    features: SHARED_FEATURES,
    specs: [
      ...SHARED_SPECS.filter((s) => s.label !== 'Size'),
      { label: 'Size', value: '11" × 3" bumper sticker' },
    ],
    bundles: buildBundles([
      { quantity: 1, price: 10.0, label: '1 Sticker', productKey: 'believeNothingIndividual', priceIdKey: 'NEXT_PUBLIC_STRIPE_PRICE_ID_BELIEVE_NOTHING_INDIVIDUAL', freeShipping: false },
      { quantity: 3, price: 24.0, label: '3 Stickers', productKey: 'believeNothingThreePack', priceIdKey: 'NEXT_PUBLIC_STRIPE_PRICE_ID_BELIEVE_NOTHING_3PACK', freeShipping: true },
      { quantity: 5, price: 36.0, label: '5 Stickers', productKey: 'believeNothingFivePack', priceIdKey: 'NEXT_PUBLIC_STRIPE_PRICE_ID_BELIEVE_NOTHING_5PACK', freeShipping: true },
    ]),
  },
];
...
/**
 * Get product by slug
 * @param {string} slug - Product slug (sticker, gadsden, taco, all-mad-here, antifa, believe-nothing)
