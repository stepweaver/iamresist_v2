...
export const metadata = buildPageMetadata({
  ...
  description:
    'Public-source intelligence desk: White House actions, Federal Register, GovInfo, optional wire confirmation, and specialist legal/election analysis — normalized into a provenance-ranked feed. Commentary stays on Voices.',
  urlPath: '/intel/osint',
});
  ...
  return (
    ...
    >
      <div className="max-w-[1600px] mx-auto px-1 sm:px-2 lg:px-3 pt-2 pb-8 sm:pb-12">
        <IntelTabs
          description="Public-source intelligence desk: White House actions, Federal Register documents, GovInfo records, optional wire confirmation, and specialist legal/election analysis — provenance-ranked. Commentary stays on Voices."
        />
        <Suspense
          fallback={
