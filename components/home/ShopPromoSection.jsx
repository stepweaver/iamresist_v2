          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center">
            {featuredProduct && (
              <Link
                ...
                className="flex items-center gap-4 p-3 sm:p-4 rounded-lg border border-border hover:border-primary bg-background/50 transition-colors group flex-1 min-w-0"
              >
